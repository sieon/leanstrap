...
<div id="comments" class="card comments-area">
	...
	<h2 class="card-header comments-title">
		<?php
			printf(
				esc_html( _nx( '&ldquo;%2$s&rdquo;上有 1 条评论', '&ldquo;%2$s&rdquo;上有 %1$s 条评论 ', get_comments_number(), 'comments title', 'start' ) ),
	...
	?>
		<p class="no-comments"><?php esc_html_e( '评论被关闭.', 'start' ); ?></p>
	<?php endif; ?>
