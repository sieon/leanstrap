...
Before getting leaned with Bootstrap's modal component, be sure to read the following as our menu options have recently changed.
...
- One again, due to `position: fixed`, there are some caveats with using modals on mobile devices. [See our browser support docs]({{ site.baseurl }}/getting-leaned/browsers-devices/#modals-and-dropdowns-on-mobile) for details.
