...
?>
	...
	<div class="alx-posts group <?php if($instance['posts_thumb']) { echo 'thumbs-enabled'; } ?>">
		...
		<div class="card">
			...
			<div class="card-block">
				...
				<p class="card-title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></p>
				<?php if($instance['posts_date']) { ?><p class="card-text"><?php the_time('j M, Y'); ?></p><?php } ?>
			</div>
