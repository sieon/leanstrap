...
/* ------------------------------------ */
	function __construct() {
      ...
      __('Lean Posts', 'lean'),
      array(
        'description' => __('Display posts from a category', 'lean'),
		...
		<li>
			...
			<div class="post-item-thumbnail">
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
					<?php the_post_thumbnail('thumbnail', ['class' => 'd-block img-fluid']);; ?>
...
?>
	...
	<div class="alx-options-posts">
		...
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("posts_orderby") ); ?>">按照顺序:</label>
			<select style="width: 100%;" id="<?php echo esc_attr( $this->get_field_id("posts_orderby") ); ?>" name="<?php echo esc_attr( $this->get_field_name("posts_orderby") ); ?>">
			  <option value="date"<?php selected( $instance["posts_orderby"], "date" ); ?>>最近发表</option>
			  <option value="comment_count"<?php selected( $instance["posts_orderby"], "comment_count" ); ?>>评论数量</option>
